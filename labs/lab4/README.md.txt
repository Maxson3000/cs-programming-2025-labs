...
Написание отчета по стандартам оформления ВВГУ - СК СТО 2015
Отчет должен СТРОГО соответствовать СТО, любые отклонения наказываются снятием баллов за работу
Отчет сдается либо в PDF, либо в DOCX в цифровом виде (печатать не нужно)
Пример отчета можно посмотреть тут (для создания использован vvsu-latex)
Отчет и код публикуется в вашем git репозитории (см. лабораторная 2)
Основные задания
Задание 1
...
12 - составное число
Оформление отчета
Отчет оформляется строго по СТО - скачать требования можно с сайта ВВГУ, либо отсюда
